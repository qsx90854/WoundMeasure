...
UI_BUILD = "2026-08-20 fixed-camera-v5.7-dual-marker-corner-tuning"
VIDEO_FILE_TYPES = [
...
def draw_marker_overlay_post_scale(
    ...
    Selected corner coordinates are blue ``+`` crosshairs.  Raw CORNER_REFINE_NONE
    ...
    def _format_metrics(self, result: dict[str, Any]) -> str:
        ...
        if isinstance(diagnostics, dict):
            ...
            if isinstance(corner_refine, dict):
                lines.extend(("", "=== RAW detectMarkers -> SELECTED CORNER DIAGNOSTICS ==="))
