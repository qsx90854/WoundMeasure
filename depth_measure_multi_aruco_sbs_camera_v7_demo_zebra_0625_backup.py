...
def main():
    ...
    scatter_grad_inject = ax_A.scatter([], [], s=15, c='#0047AB', alpha=0.85, zorder=4)
    scatter_grad_match = ax_B.scatter([], [], s=15, c='#0047AB', alpha=0.85, zorder=4)
    ...
    # 統一設定字型、文字顏色與邊框寬度
    for b in [btn_lock_L, btn_lock_R, btn_hide_R, btn_norm_toggle, btn_calc, btn_auto_calc, btn_grad_toggle, btn_custom_plane, btn_rt_diff, btn_return_menu]:
    ...
    for b in [btn_norm_toggle, btn_grad_toggle, btn_custom_plane, btn_rt_diff]:
