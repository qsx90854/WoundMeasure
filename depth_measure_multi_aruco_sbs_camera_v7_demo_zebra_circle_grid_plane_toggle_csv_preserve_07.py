...
def main():
    ...
    btn_circle_csv = Button(ax_btn_circle_csv, "24Pt CSV", **btn_style)
    ...
    def on_export_circle_heights_csv(event):
        ...
        depth_text.set_text(
            f"24Pt CSV saved: {valid_count}/{expected_count} valid\n"
            f"Plane: {reference_plane_mode} | matching: CircleLabel")
        request_blit_refresh()
